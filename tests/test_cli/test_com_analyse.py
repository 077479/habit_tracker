...
class TestAnalyse(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.orig_habtrack = cli.com_analyse.habtrack
        ...
        cli.command.habtrack.storage.deserialize.return_value = [TestAnalyse.fake_hab]


        cli.com_analyse.habtrack = Mock()        
        cli.com_analyse.habtrack.analyse.get_streaks.return_value = list()
        cli.com_analyse.habtrack.analyse.get_longest_streak.return_value = "test_streak"
        cli.com_analyse.habtrack.analyse.get_habits_by_period.return_value = "by_period"
        cli.com_analyse.habtrack.analyse.list_habits.return_value = "list_habs"
    ...
    def test_get_streaks(self):
        ...
        assert cli.com_analyse.habtrack.analyse.get_streaks.called
    ...
    def test_get_habits_by_period_call(self):
        ...
        cli.com_analyse.habtrack.analyse.get_habits_by_period.assert_called_with([TestAnalyse.fake_hab], "weekly")

    def test_get_habits_by_period_print(self):
        """test for the right call"""
        cli.com_analyse.Analyse(False).get_habits_by_period()
        cli.com_analyse.habtrack.analyse.list_habits.assert_called_with("by_period")
    ...
    def test_is_broken_call(self):
        ...
        cli.com_analyse.habtrack.analyse.is_broken.assert_called_with(TestAnalyse.fake_hab)
    ...
    def test_get_longest_streak_all_call(self):
        ...
        cli.com_analyse.habtrack.analyse.get_longest_streak_of_habits.assert_called_with([TestAnalyse.fake_hab])

    # ===== list_checkoffs ===== #
    def test_list_checkoffs_call(self):
        """test for the right call"""
        cli.com_analyse.Analyse(False).list_checkoffs()
        cli.com_analyse.habtrack.analyse.list_checkoffs.assert_called_with(TestAnalyse.fake_hab)
