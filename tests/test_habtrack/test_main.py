...
class TestMain(unittest.TestCase):
    ...
    def test_create_habit_type(self):
        ...
        hab = habtrack.main.create_habit(name="NEMO_TEST", periodicity="daily")
    ...
    def test_delete_habit_test(self):
        ...
        habtrack.main.delete_habit(habs[0], habs)
    ...
    def test_check_off_len(self):
        """test for right state after call"""
        habtrack.main.check_off(self.habit_obj)
    ...
    def test_change_period_type(self):
        """test for right state after call"""
        habtrack.main.change_period(self.habit_obj, "daily")
        assert self.habit_obj.periodicity.__module__ == "habtrack.period"
