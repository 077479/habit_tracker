...
class TestPeriod(unittest.TestCase):
    ...
    def test_period_init_1(self):
        ...
        assert habtrack.period.Period("daily").period == "daily"
    ...
    def test_period_init_defect_input(self, name, periodicity):
        ...
        with pytest.raises(TypeError):
            habtrack.period.Period(periodicity)


    # # ===== - object - ===== #
    def test_period_set_fct_1(self):
        """test for the right state after initialization"""
        habtrack.period.Period("daily")(datetime.date(2000,1,1),1) == (datetime.date(2000,1,1), datetime.date(2000,1,2))
    def test_period_set_fct_2(self):
        """test for the right state after initialization"""
        habtrack.period.Period("daily")(datetime.date(2000,1,1),4) == (datetime.date(2000,1,1), datetime.date(2000,1,5))
    def test_period_set_fct_3(self):
        """test for the right state after initialization"""
        habtrack.period.Period("weekly")(datetime.date(2000,1,1),1) == (datetime.date(2000,1,1), datetime.date(2000,1,8))
    def test_period_set_fct_4(self):
        """test for the right state after initialization"""
        habtrack.period.Period("monthly")(datetime.date(2000,1,1),1) == (datetime.date(2000,1,1), datetime.date(2000,2,1))